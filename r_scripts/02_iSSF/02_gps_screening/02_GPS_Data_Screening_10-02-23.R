...
locs_raw <- read_csv("data/Location_Data/Source_Files/locations_master/gps_locs_master_10-02-2023.csv",  col_types = list(fix_type = col_character()))
...
#########################################################################
##
## 8. Remove locations outside of study area (removes 299 locations)
##
##########################################################################
...
get_dupes(geo_screened_df, deployment_id, date_time_utc)


#write_csv(geo_screened_df, "data/Location_Data/Source_Files/locations_master/gps_locs_dop_screened_10-02-2023.csv")
