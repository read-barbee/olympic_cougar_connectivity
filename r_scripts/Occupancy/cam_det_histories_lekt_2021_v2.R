...
cam_act <-read_csv("data/Camera_Data/2021/LEKT_2021/2021.Camera.Activity.Sheet.csv") %>%
...
#species detections
cougar_det <- read_csv("data/Camera_Data/2021/LEKT_2021/S3071_20210419_20211209_2022.09.12_20.04_metadata_tbl.csv", col_types = cols(DateTimeOriginal = col_character())) %>% 
  clean_names() %>% 
