...
cam_act <- read_csv("data/Camera_Data/2021/PNPTC_2021/2021_CameraActivitySheet.csv") %>% 
  select(-c(Country, Study, `Elevation(m)`))

cougar_det <- read_csv("data/Camera_Data/2021/PNPTC_2021/2021_Cougars_OnlySightings_formatted.csv") %>% 
  select(station_id:capture_time_local) %>%
...
# write_csv(det_hist_binary, "data/Camera_Data/2021/PNPTC_2021/pnptc_2021_det_hist.csv")
# write_csv(det_hist_counts, "data/Camera_Data/2021/PNPTC_2021/pnptc_2021_det_hist_counts.csv")
# write_csv(det_hist_full, "data/Camera_Data/2021/PNPTC_2021/pnptc_2021_det_hist_long.csv")
