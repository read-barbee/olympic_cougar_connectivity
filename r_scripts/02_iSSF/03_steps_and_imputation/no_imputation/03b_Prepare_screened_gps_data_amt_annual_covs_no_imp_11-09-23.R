...
cov_folder_path <- "data/Habitat_Covariates/annual_covariates/annual_stacks_by_cov"
...
#function to convert locatons to steps
...
amt_steps <- amt_locs %>% 
  ...
  #resume here: not quite working. Try amt::extract_covariates_time_var once pure stacks are exported 
...
#########################################################################
##
## 11. Extract annual covariate values
##
#######################################################################
amt_covs <- amt_steps %>% 
