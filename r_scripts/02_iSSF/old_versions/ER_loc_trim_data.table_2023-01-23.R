...
## Raw ##
er_locs_raw <- fread("data/Location Data/All Location Data from EarthRanger/OCP_full_loc_export_2023-01-13.csv")

deployments_raw <- fread("data/Location Data/OCP_Cougar_Deployments_1-13-2023.csv")


## Clean ##

er_locs_raw <- clean_names(er_locs_raw)

er_locs_raw[,subject:lon]

er_locs_raw[,recorded_at := ymd_hms(recorded_at)]
head(er_locs_raw)
