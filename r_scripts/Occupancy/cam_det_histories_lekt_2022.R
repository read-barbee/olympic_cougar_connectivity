...
cam_act <-read_csv("data/Camera_Data/2022/LEKT_2022/2022.Activity.Sheet.NEW.csv") %>%
...
#species detections
cougar_det <- read_csv("data/Camera_Data/2022/LEKT_2022/2022 OCP Camera Data.csv") %>% 
  clean_names() %>% 
  ...
  mutate(timestamp = mdy_hm(timestamp),
         date = mdy(date),
         time = hm(time)) %>%
  select(station_id, date, time, timestamp, species) %>% 
  filter(species=="Puma")
...
# write_csv(det_hist_binary, "data/Camera_Data/2022/LEKT_2022/lekt_2022_det_hist.csv")
# write_csv(det_hist_counts, "data/Camera_Data/2022/LEKT_2022/lekt_2022_det_hist_counts.csv")
# write_csv(det_hist_full, "data/Camera_Data/2022/LEKT_2022/lekt_2022_det_hist_long.csv")
