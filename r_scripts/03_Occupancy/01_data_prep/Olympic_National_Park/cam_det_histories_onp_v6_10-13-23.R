...
det_hist_full <- act_mat_long %>% 
  ...
  select(station_id:cell_id, date, cam_status, bait_status, snare_status, cougar_detections_count, cougar_detections_binary)
...
#write_csv(det_hist_corrected, "data/Camera_Data/Olympic_National_Park/onp_fisher_2013_2016_det_hist_long_10-13-23.csv")
